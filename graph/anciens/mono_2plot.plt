...
file = 'SOD_nodifvit_CFL_05_1e4.dat'
file2 = 'SOD_CFL_05_1e4.dat'
...
set style line 1 linetype 1 lw 2 lc rgb "green" 
set style line 2 linetype 1 lw 2 lc rgb "blue"
set style line 3 linetype 1 lw 2 lc rgb "red"
plot  file using 1:2 with lines ls 1  title  'rho-analytique', file using 1:6 with lines ls 2 title 'rho-ancien', file2 using 1:6 with lines ls 3 title 'rho-A1'
