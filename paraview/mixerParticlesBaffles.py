...
listeBaffles=glob.glob('/home/bruno/doctorat/mesh/PBT_Manon/baffles/baff*.stl')
#liste.sort()
...
baffles=STLReader(FileNames=listeBaffles)
...
#Next
square=LegacyVTKReader(FileNames=listeBaffles)
